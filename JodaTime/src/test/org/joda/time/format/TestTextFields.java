...
public class TestTextFields extends TestCase {
    ...
    public void testMonthNames_monthStart() {
        DateTimeFormatter printer = DateTimeFormat.getInstance().forPattern("MMMM");
    ...
    public void testWeekdayNames() {
        DateTimeFormatter printer = DateTimeFormat.getInstance().forPattern("EEEE");
        for (int i=0; i<ZONES.length; i++) {
    ...
    public void testHalfdayNames() {
        DateTimeFormatter printer = DateTimeFormat.getInstance().forPattern("a");
        for (int i=0; i<ZONES.length; i++) {
            Chronology chrono = Chronology.getISO(ZONES[i]);
