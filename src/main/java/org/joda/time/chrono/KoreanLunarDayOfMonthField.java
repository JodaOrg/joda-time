...
/**
 * An implementation of day of month in Korean Lunar Chronology<br>
 * This class uses {@link KoreanLunarCalendar} for detail calculation. 
 * 
 * @author Billie Yang
 */
public class KoreanLunarDayOfMonthField extends DateTimeField {
	@Override
	...
	public int get(long instant) {
		return KoreanLunarCalendar.getInstance().getDayOfMonth(instant);
	}
