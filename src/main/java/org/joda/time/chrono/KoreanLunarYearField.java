...
/**
 * An implementation of year in Korean Lunar Chronology<br>
 * This class uses {@link KoreanLunarCalendar} for detail calculation.
 * 
 * @author Billie Yang
 */
public class KoreanLunarYearField extends DateTimeField {
	@Override
	...
	public int get(long instant) {
		return KoreanLunarCalendar.getInstance().getYear(instant);
	}
